...
type CreateExpensePayload struct {
	...
	ExpenseDate string          `json:"expense_date" binding:"required,datetime=2006-01-02"  example:"2006-01-02"`
}
type UpdateExpensePayload struct {
	...
	ExpenseDate *string          `json:"expense_date" binding:"omitnil,datetime=2006-01-02"  example:"2006-01-02"`
}
