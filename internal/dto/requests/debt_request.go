...
type CreateDebtPayload struct {
	...
	Type       string          `json:"type" binding:"required,debt_type" enums:"OWE,LENT"`
...
type UpdateDebtPayload struct {
	...
	Type       *string          `json:"type" binding:"omitnil,debt_type" enums:"OWE,LENT"`
...
type DebtFilter struct {
	Type   *string `form:"type" binding:"omitempty,debt_type" enums:"OWE,LENT"`
